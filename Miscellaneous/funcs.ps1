...
# Source: Made for myself whilst making AIO-Video
function Get-Path ($FileName){
    ...
    switch ($FileName.Split('.')[1]){
        ...
        {$PSItem -in $null,''}{
            Write-Output 'Get-Path ERROR: You need to provide a file extension'
        }
...
# Source: https://github.com/riedyw/PoshFunctions
